...
public class BasicLogin {
    ...
    public void test() {
        ...
        WebElement longtext = wait.until((ExpectedConditions.presenceOfElementLocated(MobileBy.xpath("//android.widget.TextView[contains(@text, 'You are logged in')]"))));

        assert(longtext.getText().contains("alice"));
